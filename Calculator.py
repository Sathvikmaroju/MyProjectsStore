...
class Application(Frame):
    ...
    def create_widgets(self):
        ...
        command = lambda : self.buttonClick(7),font = ("Helvetica", 20, "bold"), )
        ...
        # Button for value 0
        self.button9 = Button(self, bg = "#98DBC6", bd = 12, text = "0",  padx = 33, pady = 25,
        ...
        # Division button
        self.Divbutton = Button(self, bg = "#98DBC6", bd = 12, text = "/",  padx = 39, pady = 25,
        command = lambda : self.buttonClick("/"), font = ("Helvetica", 20, "bold"))
...
calculator.resizable(width = False, height = False) # Make window size fixed 
